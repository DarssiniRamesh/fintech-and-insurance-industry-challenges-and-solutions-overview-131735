...
- Primary: #32D5D1 (turquoise) — key accents, CTAs, highlight chips
...
- Icons/Accent glyphs: Prefer #32D5D1 for primary, #2563EB or #4338CA for secondary/tertiary.
- CTAs: Solid buttons with #32D5D1 background and white text; hover #14B8A6.
- Chips/Pills: Outline with #32D5D1 (1px) or filled with #32D5D1 at low alpha on white.
...
- CTAs:
  - Primary: #32D5D1 background, white text, hover #14B8A6, radius 12px.
  - Secondary: Outline button with 1px #E5E7EB border, text #111827, hover background #F9FAFB.
- Accent: Thin top divider line (#E5E7EB) across full width to ground the hero; optional subtle turquoise underline below title (2–4px, #32D5D1 at 60% opacity).
...
- Icon color: #1E3A8A or #2563EB; small turquoise (#32D5D1) dot/underline accent under title.
- Title: #111827; Eyebrow label (uppercase) in #6B7280.
- Bullets: #6B7280 with custom bullet dot:
  - Dot: 8px circle #2563EB or #32D5D1, left gutter.
...
- Feature cards:
  ...
  - Titles: #111827.
  - Body: #6B7280.
  - Left accent bar: 4px vertical strip #32D5D1 at 80% opacity.
  - Borders: 1px #E5E7EB.
- Icons inside features: #32D5D1 or #2563EB; use consistent size.
...
- Mini-card structure:
  ...
  - Optional small icon in #32D5D1 before title.
- Right visual frame:
...
- Node colors:
  - Primary nodes (UI, API, Core): outline #1E3A8A; text #111827; small icon in #32D5D1.
  - Data nodes (DB, Cache, Queue): outline #32D5D1; text #111827; small accent label #6B7280.
...
- Each card:
  ...
  - Icon: #32D5D1 centered above title; hover/selection state (if interactive later): 1px border shifts to #2563EB and subtle background #F9FAFB.
- Section header: “Use Cases” in #111827 with a turquoise underline bar (2–4px #32D5D1 at 80% opacity).
...
- Dots:
  - Active/current: filled #32D5D1 with subtle outer ring (2px) #2563EB at 20% opacity.
...
- Cards per phase:
  ...
  - Title: #111827; Bullets in #6B7280 with 8px turquoise bullet markers #32D5D1.
...
- Accent Bar (Left strip on cards):
  - 3–4px width; #32D5D1 (primary) or #2563EB (secondary).
- Bullet Dots:
  - 8px circle; use #32D5D1 for primary lists; #2563EB for secondary.
- Pill/Badge:
  - Outline variant: 1px #4338CA with #4338CA text.
- Dividers:
  - Full-width or section dividers in #E5E7EB; 24px spacing above/below.
- Iconography:
  - Stroke-weight consistent; use monochrome color fills from: #32D5D1 (primary), #2563EB (link), #4338CA (accent).
...
- Buttons must maintain 4.5:1 contrast for label text; white text on #32D5D1 meets this.

Suggested Slidev/Code Integration Notes
- Cards: Shared component with props for eyebrow, title, icon color, accent bar color.
- Buttons: Two variants (primary, outline) with Vlinder tokens above.
